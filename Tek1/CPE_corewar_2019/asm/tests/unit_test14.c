...
Test(create_file_and_write, init_flag_test)
{
    params_t params;
    char *file[] = {my_strdup(".name \n"), my_strdup(".comment \n"),
        ...
        my_strdup("ld %0, r3\n"), my_strdup("zjmp %:hji\n"),
        my_strdup("ld %1, r2\n"), NULL};
    clean_file(file, &params);
    get_magic_int(&params);
    cr_assert(1 == 1);
}

Test(create_file_and_write_1, init_flag_test)
{
    params_t params;
    char *file[] = {my_strdup(".name \n"), my_strdup(".comment \n"),
        my_strdup("sti r1, :hji, %1\n"), my_strdup("hji:	live %234\n"),
...
Test(create_file_and_write_2, init_flag_test)
{
    params_t params;
...
Test(create_file_and_write_3, init_flag_test)
{
    params_t params;
    core_t core;
